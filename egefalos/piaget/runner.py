...
Usage:
    from egefalos.piaget.runner import run_piaget_benchmark
...
def run_piaget_benchmark(model, tokenizer, specialist_map: dict = None,
    ...
    """
    from egefalos.piaget.sensorimotor import run_sensorimotor
    from egefalos.piaget.preoperational import run_preoperational
    from egefalos.piaget.concrete_operational import run_concrete_operational
    from egefalos.piaget.formal_operational import run_formal_operational
...
if __name__ == '__main__':
    ...
    print('  from egefalos.piaget.runner import run_piaget_benchmark')
